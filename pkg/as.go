...
func (s *ASService) Search(ctx context.Context, filters []map[string]SearchParameter, limit, offset int) ([]*AS, error) {
...
func (s *ASService) SearchCount(ctx context.Context, filters []map[string]SearchParameter) (int64, error) {
